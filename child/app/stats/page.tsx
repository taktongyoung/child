  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">출석 통계</h1>
        ...
        {statsData && (
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="text-center">
                  <div className={`text-3xl font-bold ${getStatusColor(statsData.totalStats.attendanceRate)}`}>
        ...
        {statsData && (
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">시각적 통계</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="h-80" id="total-stats-chart">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="h-80" id="class-stats-chart">
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-8">
              ...
              <div className="h-80" id="class-attendance-chart">
            ...
            {statsData.weeklyStats.length > 0 && (
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="h-80" id="weekly-trend-chart">
        ...
        {statsData && statsData.weeklyStats.length > 0 && (
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">출석 인원수 분석</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="h-80" id="weekly-attendance-count-chart">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="h-80" id="class-weekly-attendance-chart">
        ...
        {statsData && !selectedClass && (
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">반별 통계</h2>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {statsData.weeklyStats.map((week, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          {new Date(week.date).toLocaleDateString('ko-KR', {
                            year: 'numeric',
                        ...
                        if (sortField) {
                          ...
                          switch (sortField) {
                            case 'name':
                              aValue = a.name;
                              bValue = b.name;
                              const nameComparison = aValue.localeCompare(bValue, 'ko');
                              return sortDirection === 'asc' ? nameComparison : -nameComparison;
                            
                            case 'className':
                              aValue = classOrder.indexOf(a.className);
                              bValue = classOrder.indexOf(b.className);
                              break;
